...
use crate::utils::{
    matrix::restore_matrix_client, use_tokio_track_watcher, worker::Requester,
...
fn main() {
    ...
    let requester = MatrixClientWorker::spawn();
    ...
    let (reactions_tx, reactions_rx) = watch::channel::<Vec<utils::ReceivedReaction>>(vec![]);
