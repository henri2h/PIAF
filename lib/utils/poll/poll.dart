...
import 'json/event_poll_response.dart';
import 'json/event_poll_start.dart';
...
class Poll {
  ...
  Set<Event> get references =>
      e.aggregatedEvents(t, MatrixRelationshipTypes.reference);
  ...
  Future<void> answer(String? value) async {
    ...
    Map<String, dynamic> responseMap = {
      ...
      'm.relates_to': {
        'event_id': e.eventId,
        'rel_type': MatrixRelationshipTypes.reference,
      }
    };
