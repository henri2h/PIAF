...
@RoutePage()
class DeviceMediaGalleryPage extends StatefulWidget {
  const DeviceMediaGalleryPage({super.key});

  @override
  State<DeviceMediaGalleryPage> createState() => _DeviceMediaGalleryPageState();
}

class _DeviceMediaGalleryPageState extends State<DeviceMediaGalleryPage> {
