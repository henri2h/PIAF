...
class BackgroundPush {
  ...
  BackgroundPush._(this.client) {
    ...
    firebase?.setListeners(
      onMessage: (message) => pushHelper(
        ...
        client: client,
        activeRoomId:
            null, //router?.currentState?.pathParameters['roomid'], // TODO: get active room id
  ...
  factory BackgroundPush(Client client, BuildContext context,
  ...
  Future<void> goToRoom(NotificationResponse? notificationResponse) async {
    try {
      Logs().v(
          '[Push] Attempting to go to room ${notificationResponse?.payload}...');
...
//    await UnifiedPush.registerAppWithDialog(context!);
  ...
  Future<void> _onUpMessage(Uint8List message, String i) async {
    ...
    await pushHelper(
      ...
      client: client,
      activeRoomId:
          null, //router?.currentState?.pathParameters['roomid'], // TODO: set active room id
    );
  }
